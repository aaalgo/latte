CC = g++
CXXFLAGS += -O3 -g -std=c++11 -I/usr/include/python2.7 -Iaffy/sdk/ -D_INCLUDE_UNISTD_HEADER_=1
LDFLAGS += -L/usr/lib/python3.5/config-3.5m-x86_64-linux-gnu -L/usr/lib/python2.7/config-x86_64-linux-gnu/
